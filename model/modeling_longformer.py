"""
This is a copy from transformer's modeling_bert, modified to remove type_ids and absolute positional embeddings
"""
...
class LongformerEmbeddings(nn.Module):
    ...
    def forward(self, input_ids=None, token_type_ids=None, position_ids=None, inputs_embeds=None):
        ...
        position_embeddings = 0  # self.position_embeddings(position_ids)
        token_type_embeddings = 0  # self.token_type_embeddings(token_type_ids)
